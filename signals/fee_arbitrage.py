...
from core.category import effective_category, BLOCKED_CATEGORIES_FEE_ARB
...
class FeeArbitrageScanner:
    ...
    async def _check_extreme_price(
        ...
        # Category blocklist — 90-day backtest showed "unknown" and "weather"
        # are where fee_arbitrage bleeds (−$168 and −$38 respectively).
        # The crypto/sports/politics slice is +$115 at 100% winR.
        if effective_category(market) in BLOCKED_CATEGORIES_FEE_ARB:
            return None
